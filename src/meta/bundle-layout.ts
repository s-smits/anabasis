 ...
 * built its tree from the same constant as the code under test would follow a rename and pass
 * either way, so the layout would stop being checked by anything at the moment it changed.
 */
