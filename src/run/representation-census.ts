// Gate audit 2026-09-25 (docs/gate-audit.md, representation-blocking): commented out (unsure): the census this header describes is archived below; what stays live is the witness shape and inputInsensitivity
// /**
...
// Gate audit 2026-09-25 (docs/gate-audit.md, representation-blocking): commented out (unsure): imports only the census below read
