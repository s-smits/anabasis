...
/** The preset list is well formed and something prepares the answer. Whether a fresh candidate
 *  selected a shell has one owner, `solverShellFindings` in candidate-check. */
