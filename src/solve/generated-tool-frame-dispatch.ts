 ...
 *  Number, Set and WeakMap, locks the JSON globals and opens stdin. The decision therefore lives
 *  here, over a line and the phase the session has reached, so it can be read and tested without
 *  starting a process — and so a fault reaches the controller under the name of the rule it broke.
 */
