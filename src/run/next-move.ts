 ...
 * session writes into: the 13 September seeded continuation recorded an empty opening epoch beside
 * the working one, because only the build step carried the pass. */
