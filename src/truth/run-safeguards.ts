...
/** Safeguard 40 (2026-09-07): a refused submit whose findings repeat one code across most of the
 * battery is one defect reported once per task, the run51 and run52 shape, and the recorded
 * findings keep only the count. The floor is a 25-task battery refused on one cause. */
