...
/**
 * A bundle entry that is neither a regular file nor a directory. Rejection, not omission
 * (handover 2026-07-11): silently skipping a symlink left it in the tree unhashed and unscanned,
 * so the content address vouched for a bundle whose runtime behaviour it did not cover — a
 * traversal through the link can escape the recorded tree.
 */
