 ...
 * A missing case record is zero rows: a battery refused before any case ran (run62-opus-0904,
 * sol-stable-20260905T1000Z) is an operational result with a zero denominator, not an
 * unreadable one.
 */
