...
/** `operator-signal`: the controller caught SIGTERM (run c66e0d, 2026-09-07: the operator's
 *  four-hour stop occurred 38 minutes into battery i03, before any verdict). The final battery then
 *  has accepted artifacts under `candidates/` and no record; the evidence reader still opens the
 *  completed rounds instead of refusing the whole run. */
