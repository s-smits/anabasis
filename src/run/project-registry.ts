 ...
 *  a symlink, and a registry per checkout forgot every id whose campaign directory later went to the
 *  Trash, so `…-3fd52f9e-15` went to three unrelated runs between 16 and 21 September. */
