 ...
 * because the tasks moved, which is the whole claim a climb makes; and once three batteries in a row
 * read below the aim, the next round stops instead of paying for a fifth, and records the placement
 * it stopped on.
 *
...
const CEILING = 2;
/** The four batteries in order. The first is within the ceiling throughout, so the product passes it
