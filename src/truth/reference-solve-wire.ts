 ...
 * writes before it will accept a task. With one declaration, a controller-side mismatch cannot be
 * misattributed to the candidate as a `generated-solve-protocol` product defect.
 *
