...
export interface FullRunArgs {
   ...
   *  round in flight still records its battery, so nothing is killed. Run c66e0d, 2026-09-07, is
   *  the cost of the alternative: a manual kill at the four-hour mark discarded 21 accepted
   *  artifacts minutes from verification. */
  stopAfterMs?: number;
