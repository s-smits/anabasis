 ...
 */
// Gate audit 2026-09-25 (docs/gate-audit.md, agent-deciding-computation): commented out (unsure): only the
// deciding-computation scan reads these.
...
// Gate audit 2026-09-25 (docs/gate-audit.md, agent-deciding-computation): commented out (unsure): the scan
// parsed each module it compared.
...
// Gate audit 2026-09-25 (docs/gate-audit.md, agent-deciding-computation): commented out (unsure): only the
// deciding-computation scan below reads these.
...
// agent-side copy scan was its other caller.
...
//  *  agree on, so only a shared computation is a finding. */
