 ...
 * Nothing but a test held them together, and a test is the wrong owner for this: changing the
 * child's `/v3` to `/v4` and leaving the parent alone fails 15 of the 20 tests across
